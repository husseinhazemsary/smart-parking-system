    ...
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 32 }}>
        <div>
          ...
          <p style={{ color: T.textMuted, margin: '4px 0 0' }}>Manage all parking facilities</p>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(320px, 1fr))', gap: 16 }}>
          {lots.map(lot => (
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 6, color: T.textMuted, fontSize: 13, marginTop: 6 }}>
                <MapPin size={13}/> {lot.address}
              </div>
              <div style={{ display: 'flex', gap: 12, marginTop: 12, fontSize: 13 }}>
                <span style={{ color: T.accent }}>{lot.hourlyRate} EGP/hr</span>
                <span style={{ color: T.textMuted }}>{lot.openingTime} – {lot.closingTime}</span>
              </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
              ...
              <button onClick={() => setShowForm(false)} style={{ background: 'none', border: 'none', color: T.textSecondary, cursor: 'pointer' }}>
                <X size={20}/>
              </button>
            </div>
