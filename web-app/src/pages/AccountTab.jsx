...
const CSS = `
  ...
  /* Web layout helpers (desktop only) */
    ...
    <Modal open={open} onClose={onClose} maxWidth={420}>
      <div style={{ padding: "26px 22px" }}>
        ...
        <div style={{ display: "flex", gap: 10, marginTop: 22 }}>
          ...
          <div style={{ flex: 2 }}>
            <GlowBtn full noArrow onClick={onClose}>
              Save Changes
            </GlowBtn>
          </div>
        </div>
    ...
    <Modal open={open} onClose={onClose} maxWidth={420}>
      <div style={{ padding: "26px 22px" }}>
        ...
        <div style={{ display: "flex", gap: 10, marginTop: 22 }}>
          ...
          <div style={{ flex: 2 }}>
            <GlowBtn full noArrow onClick={handleAdd}>
              Add Vehicle
            </GlowBtn>
          </div>
        </div>
    ...
    <div className="acc-wrap acc-container">
      ...
      <div style={{ maxWidth: 1040, margin: "0 auto" }}>
        ...
        >
          <div
            style={{
              padding: isMobile ? "28px 18px 24px" : "34px 26px 26px",
            }}
          >
            ...
            >
              {[
                ...
                >
                  <div style={{ fontSize: isMobile ? 17 : 20, fontWeight: 800, color: "#fff", marginBottom: 2 }}>
                    {s.val}
                  </div>
        ...
        {/* Web-like layout: stack on mobile, 2 columns on desktop */}
